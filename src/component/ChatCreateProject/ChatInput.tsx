...
export const ChatInput = ({
  ...
  const {
    state: {
      projectConversation: selectedConversation,
      conversations,
      messageIsStreaming,
      prompts,
    },
  ...
  return (
    ...
    >
      <div className="stretch mx-2 mt-4 flex flex-row gap-3 last:mb-2 md:mx-4 md:mt-[52px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        {messageIsStreaming && (
          <button
            className="absolute left-0 right-0 top-0 mx-auto mb-3 flex w-fit items-center gap-3 rounded border border-neutral-200 bg-white px-4 py-2 text-black hover:opacity-50 md:mb-0 md:mt-2 dark:border-neutral-600 dark:bg-[#343541] dark:text-white"
        ...
        <div className="relative mx-2 flex w-full flex-grow flex-col rounded-md border border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] sm:mx-4 dark:border-gray-900/50 dark:bg-[#40414F] dark:text-white dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
          {/* <button
          ...
          <InputTextArea
            ...
            hideErrorRow
            autoResize
            placeholder="Ask more questions on the Kroger.com project..."
            className="!h-12.5 !py-3"
          />

          <button
            className="absolute right-2 top-1/2 -translate-y-1/2 transform rounded-sm p-1 text-neutral-800 opacity-60 hover:bg-neutral-200 hover:text-neutral-900 dark:bg-opacity-50 dark:text-neutral-100 dark:hover:text-neutral-200"
            onClick={handleSend}
          >
            {messageIsStreaming ? (
