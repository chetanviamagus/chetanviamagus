...
import { Bars4Icon, BarsArrowUpIcon, Squares2X2Icon } from "@heroicons/react/24/outline";
    ...
    <div className="mx-auto flex w-full flex-col p-3 md:max-w-rightContent">
      <div className="mb-6 flex flex-col items-center gap-3 px-3 pt-3 sm:flex-row sm:justify-between">
        <div className="flex gap-3">
          <Text label={"Reports"} className="text-2xl font-semibold text-dark-text-main" />
        ...
        <div className="flex gap-3">
          <div className="flex gap-3">
            <div className="group flex h-9 w-9 cursor-pointer items-center justify-center rounded-full hover:bg-black">
              <Squares2X2Icon className="h-6 w-6 text-dark-neutral-gray-600 group-hover:hover:text-dark-neutral-gray-900" />
            </div>

            <div className="group flex h-9 w-9 cursor-pointer items-center justify-center rounded-full hover:bg-black hover:text-dark-neutral-gray-900">
              <Bars4Icon className="h-6 w-6 text-dark-neutral-gray-600 group-hover:hover:text-dark-neutral-gray-900" />
            </div>

            <div className="group flex h-9 w-9 cursor-pointer items-center justify-center rounded-full hover:bg-black hover:text-dark-neutral-gray-900">
              <BarsArrowUpIcon className="h-6 w-6 text-dark-neutral-gray-600 group-hover:hover:text-dark-neutral-gray-900" />
            </div>
          </div>
      ...
      <div className="screen-bg flex w-full flex-col gap-3 rounded-md p-3">
        <div className="grid w-full grid-cols-3 gap-3">
          <div className="col-span-3 md:col-span-2 lg:col-span-1">
            <ChartCard
              title={"Power Usage Nov 23"}
              subtitle={"28 Nov 2023"}
              graph={
          ...
          <div className="col-span-3 md:col-span-2 lg:col-span-1">
            <ChartCard
              title={"Server Performance Oct 23"}
              subtitle={"29 Oct 2023"}
              graph={
                <div className="w-full">
          ...
          <div className="col-span-3 lg:col-span-2">
            <ChartCard
              title={"Daily Active User Oct 23"}
              subtitle={"29 Oct 2023"}
              graph={
          ...
          <div className="col-span-3 md:col-span-2 lg:col-span-1">
            <ChartCard
              title={"CPU Usage Nov 23"}
              subtitle={"29 Nov 2023"}
              graph={
                <div className="w-full">
                  <NivoPieChart
                    className="secondary-pie !h-60 w-full !pb-0"
