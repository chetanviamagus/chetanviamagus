...
import useErrorService from "service/errorService";
...
import { OpenAIModelID, OpenAIModels, fallbackModelID } from "util/types/openai";
...
const View1 = ({
  ...
  // const data = { id: "asndffhgasd", name: "Arindam", tokenLimit: 100, maxLength: 100 };
    ...
    >
      <div className={`flex h-full mx-auto w-full md:max-w-rightContent p-3 flex-col text-sm text-white dark:text-white ${lightMode}`}>
        <div className="fixed top-0 w-full sm:hidden">
          {/* @ts-ignore :we will fix it later */}
          <Navbar
